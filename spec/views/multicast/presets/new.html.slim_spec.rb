...
RSpec.describe "multicast/presets/new", type: :view do
  before(:each) do
    assign(:multicast_preset, Multicast::Preset.new(
  ...
  it "renders new multicast_preset form" do
    render

    assert_select "form[action=?][method=?]", multicast_presets_path, "post" do
